...
const (
	goreleaserVersion = "v2.18.1" // renovate: datasource=github-releases depName=goreleaser/goreleaser
	...
	renovateVersion = "44.56.3"                                    // renovate: datasource=npm depName=renovate
