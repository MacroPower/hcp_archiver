...
const (
	goreleaserVersion = "v2.17.1" // renovate: datasource=github-releases depName=goreleaser/goreleaser
	...
	renovateVersion = "44.115.10"                                    // renovate: datasource=npm depName=renovate
